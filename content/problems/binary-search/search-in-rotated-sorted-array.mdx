...
Example 1:
<br /><pre className="overflow-x-auto">Input: nums = [4,5,6,7,0,1,2], target = 0
Output: 4
</pre>Example 2:
<br /><pre className="overflow-x-auto">Input: nums = [4,5,6,7,0,1,2], target = 3
Output: -1
</pre>Example 3:
<br /><pre className="overflow-x-auto">Input: nums = [1], target = 0
Output: -1
</pre>
