...
Example 1:
<br /><pre className="overflow-x-auto">Input: nums = [5,7,7,8,8,10], target = 8
Output: [3,4]
</pre>Example 2:
<br /><pre className="overflow-x-auto">Input: nums = [5,7,7,8,8,10], target = 6
Output: [-1,-1]
</pre>Example 3:
<br /><pre className="overflow-x-auto">Input: nums = [], target = 0
Output: [-1,-1]
</pre>
