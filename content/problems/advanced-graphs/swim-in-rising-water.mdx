...
Return *the least time until you can reach the bottom right square *<code>(n - 1, n - 1)</code>* if you start at the top left square *<code>(0, 0)</code>.

 
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/06/29/swim1-grid.jpg" width={164} height={165} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/06/29/swim2-grid-1.jpg" width={404} height={405} />
<br /><pre className="overflow-x-auto">
