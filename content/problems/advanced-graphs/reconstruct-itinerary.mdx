...
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/03/14/itinerary1-graph.jpg" width={382} height={222} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/03/14/itinerary2-graph.jpg" width={222} height={230} />
<br /><pre className="overflow-x-auto">
