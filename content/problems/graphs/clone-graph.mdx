...
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2019/11/04/133_clone_graph_question.png" width={454} height={500} />
<br /><pre className="overflow-x-auto">
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2020/01/07/graph.png" width={163} height={148} />
<br /><pre className="overflow-x-auto">
Input: adjList = [[]]
Output: [[]]
