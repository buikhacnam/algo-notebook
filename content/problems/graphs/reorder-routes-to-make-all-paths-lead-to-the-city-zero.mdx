...
<Image
	alt=""
	src="https://assets.leetcode.com/uploads/2020/05/13/sample_1_1819.png"
	width={311}
	height={189}
/>
<br />
...
<Image
	alt=""
	src="https://assets.leetcode.com/uploads/2020/05/13/sample_2_1819.png"
	width={509}
	height={79}
/>
<br />
<pre className="overflow-x-auto">
	Input: n = 5, connections = [[1,0],[1,2],[3,2],[3,4]] Output: 2 Explanation:
