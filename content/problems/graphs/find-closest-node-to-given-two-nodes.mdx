...
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2022/06/07/graph4drawio-2.png" width={321} height={161} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2022/06/07/graph4drawio-4.png" width={195} height={161} />
<br /><pre className="overflow-x-auto">
