...
Return *the largest color value of any valid path in the given graph, or *<code>-1</code>* if the graph contains a cycle*.

 
Example 1:

<Image alt="" src="https://assets.leetcode.com/uploads/2021/04/21/leet1.png" width={400} height={182} />
...
<Image alt="" src="https://assets.leetcode.com/uploads/2021/04/21/leet2.png" width={85} height={85} />
