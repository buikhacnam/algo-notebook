...
## Description
Given an array of integers <code>arr</code> and two integers <code>k</code> and <code>threshold</code>, return *the number of sub-arrays of size *<code>k</code>* and average greater than or equal to *<code>threshold</code>.
