...
Return _the maximum possible frequency of an element after performing at most _<code>k</code>_ operations_.
...
<pre className="overflow-x-auto">
	...
	element three times and the second element two times to make nums = [4,4,4]. 4
...
<br />
<pre className="overflow-x-auto">Input: nums = [3,9,6], k = 2 Output: 1</pre>
