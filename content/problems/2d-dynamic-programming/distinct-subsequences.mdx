...
## Description
Given two strings <code>s</code> and <code>t</code>, return *the number of distinct* <span data-keyword="subsequence-string">*subsequences*</span>* of *<code>s</code>* which equals *<code>t</code>.
