...
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2020/11/04/robot1.jpg" width={242} height={242} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2020/11/04/robot2.jpg" width={162} height={162} />
<br /><pre className="overflow-x-auto">
