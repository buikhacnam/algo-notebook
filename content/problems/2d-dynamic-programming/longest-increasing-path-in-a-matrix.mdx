...
## Description
Given an <code>m x n</code> integers <code>matrix</code>, return *the length of the longest increasing path in *<code>matrix</code>.

From each cell, you can either move in four directions: left, right, up, or down. You may not move diagonally or move outside the boundary (i.e., wrap-around is not allowed).

 
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/01/05/grid1.jpg" width={242} height={242} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/01/27/tmp-grid.jpg" width={253} height={253} />
<br /><pre className="overflow-x-auto">
