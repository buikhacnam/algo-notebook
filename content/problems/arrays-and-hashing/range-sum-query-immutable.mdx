...
<ol>
	...
	<code>left</code> and <code>right</code> inclusive where{' '}
...
<pre className="overflow-x-auto">
	...
	&quot;sumRange&quot;] [[[-2, 0, 3, -5, 2, -1]], [0, 2], [2, 5], [0, 5]] Output
	[null, 1, -1, -3] Explanation NumArray numArray = new NumArray([-2, 0, 3, -5,
	2, -1]); numArray.sumRange(0, 2); // return (-2) + 0 + 3 = 1
