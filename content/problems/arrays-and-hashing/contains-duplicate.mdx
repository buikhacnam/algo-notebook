...
Example 1:
<br /><pre className="overflow-x-auto">Input: nums = [1,2,3,1]
Output: true
</pre>Example 2:
<br /><pre className="overflow-x-auto">Input: nums = [1,2,3,4]
Output: false
</pre>Example 3:
<br /><pre className="overflow-x-auto">Input: nums = [1,1,1,3,3,4,3,2,4,2]
Output: true
</pre>
