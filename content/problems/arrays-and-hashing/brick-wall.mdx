...
Given the 2D array <code>wall</code> that contains the information about the wall, return _the minimum number of crossed bricks after drawing such a vertical line_.

Example 1:

<Image
	alt=""
	src="https://assets.leetcode.com/uploads/2021/04/24/cutwall-grid.jpg"
	width={493}
	height={577}
/>
<br />
...
<pre className="overflow-x-auto">Input: wall = [[1],[1],[1]] Output: 3</pre>
