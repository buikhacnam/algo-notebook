...
Example 1:
<br /><pre className="overflow-x-auto">Input: strs = ["eat","tea","tan","ate","nat","bat"]
Output: [["bat"],["nat","tan"],["ate","eat","tea"]]
</pre>Example 2:
<br /><pre className="overflow-x-auto">Input: strs = [""]
Output: [[""]]
</pre>Example 3:
<br /><pre className="overflow-x-auto">Input: strs = ["a"]
Output: [["a"]]
</pre>
