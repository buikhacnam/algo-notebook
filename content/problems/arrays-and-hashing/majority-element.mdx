...
Given an array <code>nums</code> of size <code>n</code>, return _the majority element_.
...
<br />
<pre className="overflow-x-auto">Input: nums = [3,2,3] Output: 3</pre>

Example 2:

<br />
<pre className="overflow-x-auto">Input: nums = [2,2,1,1,1,2,2] Output: 2</pre>
Constraints:
