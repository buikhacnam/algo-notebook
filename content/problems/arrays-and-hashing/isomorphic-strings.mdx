...
Example 1:
<br /><pre className="overflow-x-auto">Input: s = "egg", t = "add"
Output: true
</pre>Example 2:
<br /><pre className="overflow-x-auto">Input: s = "foo", t = "bar"
Output: false
</pre>Example 3:
<br /><pre className="overflow-x-auto">Input: s = "paper", t = "title"
Output: true
</pre>
