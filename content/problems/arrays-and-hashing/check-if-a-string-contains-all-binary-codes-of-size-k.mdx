...
## Description
Given a binary string <code>s</code> and an integer <code>k</code>, return <code>true</code> *if every binary code of length* <code>k</code> *is a substring of* <code>s</code>. Otherwise, return <code>false</code>.
