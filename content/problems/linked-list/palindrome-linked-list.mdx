...
Given the <code>head</code> of a singly linked list, return <code>true</code>_ if it is a _<span data-keyword="palindrome-sequence">_palindrome_</span>_ or _<code>false</code>_ otherwise_.
...
<pre className="overflow-x-auto">Input: head = [1,2,2,1] Output: true</pre>
...
<pre className="overflow-x-auto">Input: head = [1,2] Output: false</pre>
