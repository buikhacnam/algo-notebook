...
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/03/04/reorder1linked-list.jpg" width={422} height={222} />
<br /><pre className="overflow-x-auto">
Input: head = [1,2,3,4]
Output: [1,4,2,3]
</pre>
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/03/09/reorder2-linked-list.jpg" width={542} height={222} />
<br /><pre className="overflow-x-auto">
