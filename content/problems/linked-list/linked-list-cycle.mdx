...
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2018/12/07/circularlinkedlist.png" width={300} height={97} margin-top: 8} margin-bottom: 8} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2018/12/07/circularlinkedlist_test2.png" width={141} height={74} />
<br /><pre className="overflow-x-auto">
...
Example 3:
<Image alt="" src="https://assets.leetcode.com/uploads/2018/12/07/circularlinkedlist_test3.png" width={45} height={45} />
<br /><pre className="overflow-x-auto">
Input: head = [1], pos = -1
Output: false
