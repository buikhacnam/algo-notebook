...
Given the <code>head</code> of a linked list, return _the list after sorting it in ascending order_.
...
/>
<br />
<pre className="overflow-x-auto">Input: head = [4,2,1,3] Output: [1,2,3,4]</pre>
