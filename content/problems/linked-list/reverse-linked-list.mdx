...
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/02/19/rev1ex1.jpg" width={542} height={222} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/02/19/rev1ex2.jpg" width={182} height={222} />
<br /><pre className="overflow-x-auto">
Input: head = [1,2]
Output: [2,1]
</pre>
