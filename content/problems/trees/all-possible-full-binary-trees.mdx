...
## Description
Given an integer <code>n</code>, return *a list of all possible full binary trees with* <code>n</code> *nodes*. Each node of each tree in the answer must have <code>Node.val == 0</code>.
...
Example 1:
<Image alt="" src="https://s3-lc-upload.s3.amazonaws.com/uploads/2018/08/22/fivetrees.png" width={700} height={400} />
