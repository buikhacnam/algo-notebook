...
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/03/14/invert1-tree.jpg" width={500} height={165} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/03/14/invert2-tree.jpg" width={500} height={120} />
<br /><pre className="overflow-x-auto">
Input: root = [2,1,3]
Output: [2,3,1]
</pre>
