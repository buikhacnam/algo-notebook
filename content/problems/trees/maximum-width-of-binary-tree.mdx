...
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/05/03/width1-tree.jpg" width={359} height={302} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2022/03/14/maximum-width-of-binary-tree-v3.jpg" width={442} height={422} />
<br /><pre className="overflow-x-auto">
...
Example 3:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/05/03/width3-tree.jpg" width={289} height={299} />
<br /><pre className="overflow-x-auto">
Input: root = [1,3,2,5]
Output: 2
