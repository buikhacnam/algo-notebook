...
## Description
Given the <code>root</code> of a Binary Search Tree (BST), return *the minimum difference between the values of any two different nodes in the tree*.

 
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/02/05/bst1.jpg" width={292} height={301} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2021/02/05/bst2.jpg" width={282} height={301} />
<br /><pre className="overflow-x-auto">
