...
Return _the number of non-empty subsequences of _<code>nums</code>_ such that the sum of the minimum and maximum element on it is less or equal to _<code>target</code>. Since the answer may be too large, return it modulo <code>10<sup>9</sup> + 7</code>.
...
<pre className="overflow-x-auto">
	...
	target (3 + 3 &lt;= 9) [3,5] -&gt; (3 + 5 &lt;= 9) [3,5,6] -&gt; (3 + 6 &lt;=
	9) [3,6] -&gt; (3 + 6 &lt;= 9)
</pre>
...
<pre className="overflow-x-auto">
	...
	subsequences that satisfy the condition. (nums can have repeated numbers). [3]
	, [3] , [3,3], [3,6] , [3,6] , [3,3,6]
</pre>
...
<pre className="overflow-x-auto">
	...
	non-empty subsequences, two of them do not satisfy the condition ([6,7], [7]).
