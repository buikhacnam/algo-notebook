...
Return <code>k</code>_ after placing the final result in the first _<code>k</code>_ slots of _<code>nums</code>.
...
<pre className="overflow-x-auto">
	...
	function should return k = 5, with the first five elements of nums being 1, 1,
	2, 2 and 3 respectively. It does not matter what you leave beyond the returned
