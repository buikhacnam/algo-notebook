...
Given an array of distinct integers <code>nums</code> and a target integer <code>target</code>, return _the number of possible combinations that add up to_ <code>target</code>.
...
<br />
<pre className="overflow-x-auto">Input: nums = [9], target = 3 Output: 0</pre>
