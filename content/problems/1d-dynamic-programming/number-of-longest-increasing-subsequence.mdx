...
Given an integer array <code>nums</code>, return _the number of longest increasing subsequences._
...
<br />
<pre className="overflow-x-auto">
	Input: nums = [2,2,2,2,2] Output: 5 Explanation: The length of the longest
	increasing subsequence is 1, and there are 5 increasing subsequences of length
	1, so output 5.
</pre>
