...
Given an integer array <code>nums</code>, return <code>true</code> _if you can partition the array into two subsets such that the sum of the elements in both subsets is equal or _<code>false</code>_ otherwise_.
