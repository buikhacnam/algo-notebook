...
Given an array of integers <code>heights</code> representing the histogram&#39;s bar height where the width of each bar is <code>1</code>, return _the area of the largest rectangle in the histogram_.
...
<pre className="overflow-x-auto">
	Input: heights = [2,1,5,6,2,3] Output: 10 Explanation: The above is a
	histogram where width of each bar is 1. The largest rectangle is shown in the
...
<pre className="overflow-x-auto">Input: heights = [2,4] Output: 4</pre>
