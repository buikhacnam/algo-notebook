...
Given a circular integer array <code>nums</code> of length <code>n</code>, return _the maximum possible sum of a non-empty subarray of _<code>nums</code>.
...
<br />
<pre className="overflow-x-auto">
	Input: nums = [-3,-2,-3] Output: -2 Explanation: Subarray [-2] has maximum sum
	-2.
</pre>
