...
Return <code>true</code> *if it is possible to obtain the *<code>target</code>* triplet *<code>[x, y, z]</code>* as an element of *<code>triplets</code>*, or *<code>false</code>* otherwise*.
