...
<br />
<pre className="overflow-x-auto">P A H N A P L S I I G Y I R</pre>
...
<br />
<pre className="overflow-x-auto">string convert(string s, int numRows);</pre>

Example 1:

<br />
<pre className="overflow-x-auto">
	Input: s = &quot;PAYPALISHIRING&quot;, numRows = 3 Output:
	&quot;PAHNAPLSIIGYIR&quot;
</pre>
...
<br />
<pre className="overflow-x-auto">
	Input: s = &quot;PAYPALISHIRING&quot;, numRows = 4 Output:
