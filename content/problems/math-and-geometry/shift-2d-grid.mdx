...
Return the *2D grid* after applying shift operation <code>k</code> times.

 
Example 1:
<Image alt="" src="https://assets.leetcode.com/uploads/2019/11/05/e1.png" width={400} height={178} />
...
Example 2:
<Image alt="" src="https://assets.leetcode.com/uploads/2019/11/05/e2.png" width={400} height={166} />
<br /><pre className="overflow-x-auto">
