...
Given an integer <code>n</code>, return _all distinct solutions to the n-queens puzzle_. You may return the answer in any order.
...
<pre className="overflow-x-auto">Input: n = 1 Output: [[&quot;Q&quot;]]</pre>
