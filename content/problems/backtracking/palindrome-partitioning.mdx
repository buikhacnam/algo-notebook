...
## Description
Given a string <code>s</code>, partition <code>s</code> such that every <span data-keyword="substring-nonempty">substring</span> of the partition is a <span data-keyword="palindrome-string">palindrome</span>. Return *all possible palindrome partitioning of *<code>s</code>.

 
Example 1:
<br /><pre className="overflow-x-auto">Input: s = "aab"
Output: [["a","a","b"],["aa","b"]]
</pre>Example 2:
<br /><pre className="overflow-x-auto">Input: s = "a"
Output: [["a"]]
</pre>
